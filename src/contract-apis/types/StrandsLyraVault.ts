...
export interface StrandsLyraVaultInterface extends utils.Interface {
  functions: {
    ...
    "premiumAsset()": FunctionFragment;
    "pricePerShare()": FunctionFragment;
    "redeem(uint256)": FunctionFragment;
    "reducePosition(uint256,uint256)": FunctionFragment;
  ...
  events: {
    ...
    "Trade(address,uint256,uint256,uint256)": EventFragment;
...
export interface StrandsLyraVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StrandsLyraVaultInterface;
  ...
  functions: {
    ...
    premiumAsset(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "Trade(address,uint256,uint256,uint256)"(
      user?: null,
      positionId?: null,
      premium?: null,
      capitalUsed?: null
  ...
  estimateGas: {
    ...
    premiumAsset(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    premiumAsset(overrides?: CallOverrides): Promise<PopulatedTransaction>;
